        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                <div class="card">
                    ...
                    <hr class="dark horizontal my-0">
                    <div class="card-footer p-3">
                        <p class="mb-0"><span class="text-success text-sm font-weight-bolder">120 hari</span> lagi sebelum tamat/mula OJT</p>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
        ...
        <div class="row mt-4">
            ...
            <div class="col-lg-4 mt-4 mb-3">
                <div class="card z-index-2 ">
                    ...
                    <div class="card-body">
                        <h6 class="mb-0 ">Statistik Penilaian OJT</h6>
                        <p class="text-sm">Penilaian daripada OJT yang berlangsung dari dd/mm/yy ~ dd/mm/yy</p>
                        <hr class="dark horizontal">
                        <div class="d-flex ">
                            <a class="mb-0 text-sm" href=""><i class="fas fa-eye m-2"></i>Lihat Dokumen</a>
                        </div>
                    </div>
                </div>
            </div>
