<div class="position-relative">
    <div class="authentication-wrapper authentication-basic container-p-y">
      <div class="authentication-inner py-4">
        <div class="card p-2">
          ...
          <div class="card-body">
            ...
            <form class="mb-3" wire:submit.prevent="update">
                ...
                <div class="input-group input-group-merge">
                  <div class="form-floating form-floating-outline">
                    <input
                      type="text"
                      id="email"
                      class="form-control @if(strlen($email ?? '') > 0) is-filled @endif"
                      wire:model="email"
              ...
              <button type="submit" class="btn btn-primary d-grid w-100 mb-3">Cambiar contraseña</button>
        ...
        <img
          alt="mask"
          src="../../assets/img/illustrations/auth-basic-reset-password-mask-light.png"
